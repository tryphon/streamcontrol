...
describe MonitoringsHelper do
  ...
  describe "monitoring_image_tag" do
    ...
    it "should use the monitor presenter name is alt" do
      monitoring.presenter.stub :name => "Dummy"
      helper.monitoring_image_tag(monitoring).should have_tag("img[alt=Dummy]")
    end

    it "should use the given html options" do
      helper.monitoring_image_tag(monitoring, :class  => "dummy").should have_tag("img[class=dummy]")
    end

    it "should use the monitoring image" do
      helper.monitoring_image_tag(monitoring).should have_tag("img[src=?]","/monitorings/dummy.png")
    end
  ...
  describe "monitoring_preview_tag" do
    ...
    it "should use monitorings_path in link" do
      ...
      helper.monitoring_preview_tag(:dummy).should have_tag("a[href=?]", monitorings_path)
    end
    ...
    it "should use monitoring_image_tag as link content" do
      ...
      helper.monitoring_preview_tag(:dummy).should have_tag("a", "monitoring_image_tag")
    end
